...
//        Toast.makeText(this,musicAdapter.itemCount.toString(),Toast.LENGTH_SHORT).show()
    }
...
//        )
//
//        //just add a space in starting of DESC i.e. "DESC" --> " DESC"
...
//                    val music = Music(id = idC, title = titleC, albums = albumC, artist = artistC, path = pathC, duration = durationC)
